$(function() {
  ...
  $(document).scroll(function () {
	...
	$('.play-video1').click(function(){
		$('#video1 .modal-body').html('<iframe src="https://player.vimeo.com/video/104566107?autoplay=0" width="1000" height="562" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe>');
	});
...
//	$('header a.logo').attr('href','http://cloudgurus.guru');
	$('header a.logo').attr('href','index.php');
	...
	$('#free-video-chat button#submit').click(function(e){
		e.preventDefault();
		fname = $('#free-video-chat #fname').val();
		fname1 = $('#free-video-chat #fname');
		name = $('#free-video-chat #fname').val() +' '+ $('#free-video-chat #lname').val();
		email1 = $('#free-video-chat #email');
